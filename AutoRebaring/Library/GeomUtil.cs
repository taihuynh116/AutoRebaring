...
namespace Geometry
{
    public class GeomUtil
    {
        ...
        public static bool IsEqualOrBigger(double first, double second)
        {
            if (IsEqual(first, second)) return true;
            return first > second;
        }
        public static bool IsEqualOrBigger(XYZ first, XYZ second)
        {
            if (IsEqual(first, second)) return true;
        ...
        public static bool IsEqualOrSmaller(double first, double second)
        {
            if (IsEqual(first, second)) return true;
            return first < second;
        }
        public static bool IsEqualOrSmaller(XYZ first, XYZ second)
        {
            if (IsEqual(first, second)) return true;
            if (IsEqual(first.Z, second.Z))
            {
